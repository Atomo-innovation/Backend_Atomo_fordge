        ...
        while not stop_event.is_set():
            ...
            if line_crossing_enabled:
                ...
                for f in faces:
                    ...
                    # Emit DETECT every frame the face is visible — box position updates instantly
                    sys.stdout.write(json.dumps({
                        "event": "stream_detect",
                        "camera_id": camera_id,
                        "camera_name": camera_name,
                    ...
                    # retry while it's still unrecognized (e.g. bad angle on
                    # first frame) — but stop re-queuing once it's known to
                    # keep SFace load bounded.
                    should_recognize = (
