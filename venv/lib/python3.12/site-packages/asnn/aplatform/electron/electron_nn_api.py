import os,sys
from ctypes import *
from asnn.aplatform.electron import electron_nn_types
import numpy as np
...
class electron:
    ...
    def neural_network_create(self, library, model, level):
        ...
        if electron_nn_types.NPU_SUCCESS == val :
            return electron_nn_types.NPU_SUCCESS
        else :
            return electron_nn_types.NPU_FAILE
    ...
    def neural_network_get_output_tensor(self, i):
        ...
        get_tensor.restype = electron_nn_types.npu_tensor
        result = get_tensor(i)
        return result
